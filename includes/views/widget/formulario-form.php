...
<p>
	<label for="<?php echo esc_attr( $this->get_field_id( 'message' ) ); ?>">Texto Padrão da Mensagem:</label>
	<textarea class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'message' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'message' ) ); ?>" type="text" cols="30" rows="10"><?php echo esc_attr( $message ); ?></textarea>
</p>
<p>

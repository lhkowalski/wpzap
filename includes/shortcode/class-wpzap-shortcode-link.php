...
class WPZap_Shortcode_Link extends WPZap_General
{
	...
	{
		// hang in hooks
		add_shortcode('wpzap_link', array($this, 'doShortcode'));
	}
	...
	public function doShortcode($attributes)
	{
		...
		// get attributes
		$attributes = shortcode_atts($defaultButtonAttributes, $attributes, 'wpzap_link');

		// full link to chat
		$hrefLink = WPZap_Util::getLinkFromOptions($this->_options);

		// html of the button
		$resultHTML = "<a href='$hrefLink' target='_blank'>" . $attributes['texto'] . "</a>";
